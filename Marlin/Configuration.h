...
#define STRING_CONFIG_H_AUTHOR "(AlexeyZel, Flsun Q5 Robin Nano 3 config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // flsun Q5 via M303 E-1 C8 S70
  #define DEFAULT_bedKp 89.67
  #define DEFAULT_bedKi 16.86
  #define DEFAULT_bedKd 318.04
...
#define DELTA
  ...
  #define DELTA_HEIGHT 199.39            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.59, -1.15 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 106.62             // (mm) Get this value from G33 auto calibrate
  ...
  #define DELTA_DIAGONAL_ROD_TRIM_TOWER { -0.5, 0.0, 0.2 } // My old Marlin values
  //#define DELTA_DIAGONAL_ROD_TRIM_TOWER { 0.77, -0.26, 0.25 } // Klipper values
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 412 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -2.2, -2.1, -19.6 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 9
